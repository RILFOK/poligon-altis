...
class TAW_VDMenu {
	...
	class controlsBackground {
		...
		class ButtonFPS : RscButtonMenu {
			idc = 2923;
			text = "FPS OFF";
			onButtonClick = "[] spawn TAWVD_fnc_fpsbutton;";
			x = 0.8 - (6.25 / 40);
			y = 0.77 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
	...
	class controls {
		...
		class VD_inCar_slider : VD_onFoot_slider {
			idc = GROUND_SLIDER;
			toolTip = "Дистанция в наземной технике";
		...
		class VD_inAir_slider : VD_onFoot_slider {
			idc = AIR_SLIDER;
			toolTip = "Дистанция в воздушной технике";
		...
		class VD_Drone_slider:VD_onFoot_slider {
			idc = DRONE_SLIDER;
			toolTip = "Дистанция в беспилотнике";
		...
		class ObjectSyncCheckbox : RscCheckbox
		{
			idc = 2931;
			x = .32; y = .6;
			tooltip = "Синхронизация дистанции с объектами";
		...
		class ObjectSynctext : RscText {
			idc = -1;
			text = "Синхронизация с дистанцией";
			x = .345; y = .596;
			w = .35; h = .04;
		};
