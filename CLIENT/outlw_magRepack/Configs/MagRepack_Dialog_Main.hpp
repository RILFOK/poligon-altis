...
class MagRepack_Dialog_Main
{
	...
	class Controls
	{
		...
		class MR_Logo: outlw_MR_RscPicture
		{
			...
			text = "CLIENT\outlw_magRepack\Images\MR_logo.paa";
		...
		*/
		...
		{
			idc = 2210;
			text = "CLIENT\outlw_magRepack\Images\MR_SourceGradient.paa";
		...
		{
			idc = 2211;
			text = "CLIENT\outlw_magRepack\Images\MR_TargetGradient.paa";
